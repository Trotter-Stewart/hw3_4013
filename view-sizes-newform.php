<button type="button" class="btn btn-warm-orange" data-bs-toggle="modal" data-bs-target="#newSizeModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newSizeModalLabel">New size</h1>
